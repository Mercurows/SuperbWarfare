...
public class ModBlockStateProvider extends BlockStateProvider {
    ...
    protected void registerStatesAndModels() {
        ...
        horizontalBlock(ModBlocks.CHARGING_STATION.get(), models().cube("charging_station",
        ...
        horizontalBlock(ModBlocks.CREATIVE_CHARGING_STATION.get(), models().cube("creative_charging_station",
        ...
        horizontalBlock(ModBlocks.VEHICLE_DEPLOYER.get(), models().cubeBottomTop("vehicle_deployer", modLoc("block/vehicle_deployer_side"),
