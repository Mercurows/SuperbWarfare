    ...
    companion object {
        ...
        private fun buildAmmoRecipes(writer: RecipeOutput) {
            ...
            ShapedRecipeBuilder.shaped(RecipeCategory.COMBAT, ModItems.AP_5_INCHES.get())
                ...
                .save(writer, loc(getItemName(ModItems.AP_5_INCHES.get())))
            ...
            ShapedRecipeBuilder.shaped(RecipeCategory.COMBAT, ModItems.CM_5_INCHES.get())
                ...
                .save(writer, loc(getItemName(ModItems.CM_5_INCHES.get())))
            ...
            ShapedRecipeBuilder.shaped(RecipeCategory.COMBAT, ModItems.GS_5_INCHES.get())
                ...
                .save(writer, loc(getItemName(ModItems.GS_5_INCHES.get())))
            ...
            ShapedRecipeBuilder.shaped(RecipeCategory.COMBAT, ModItems.HE_5_INCHES.get())
                ...
                .save(writer, loc(getItemName(ModItems.HE_5_INCHES.get())))
            ...
            ShapedRecipeBuilder.shaped(RecipeCategory.COMBAT, ModItems.SMALL_SHELL.get(), 8)
                ...
                .save(writer, loc(getItemName(ModItems.SMALL_SHELL.get())))
