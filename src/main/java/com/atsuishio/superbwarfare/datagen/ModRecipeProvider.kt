...
class ModRecipeProvider(pOutput: PackOutput) : RecipeProvider(pOutput), IConditionBuilder {
    ...
    companion object {
        ...
        private fun buildVehicleRecipes(writer: Consumer<FinishedRecipe>) {
            ...
            VehicleAssemblingRecipeBuilder.entity(ModEntities.TINY_SPEEDBOAT.get(), VehicleAssemblingRecipe.Category.WATER)
            ...
            VehicleAssemblingRecipeBuilder.entity(ModEntities.SODAYO_PICK_UP.get(), VehicleAssemblingRecipe.Category.CIVILIAN)
                    .require(ModTags.Items.STORAGE_BLOCK_STEEL, 2)
            ...
            VehicleAssemblingRecipeBuilder.entity(ModEntities.SODAYO_PICK_UP_HMG.get(), VehicleAssemblingRecipe.Category.CIVILIAN)
                    .require(ModTags.Items.STORAGE_BLOCK_STEEL, 2)
                    .require(Items.CHEST, 1)
                    .require(ModItems.MEDIUM_BATTERY_PACK.get())
                    .require(ModItems.WHEEL.get(), 4)
            ...
            VehicleAssemblingRecipeBuilder.entity(ModEntities.SODAYO_PICK_UP_ROCKET.get(), VehicleAssemblingRecipe.Category.CIVILIAN)
                    .require(ModTags.Items.STORAGE_BLOCK_STEEL, 3)
                    .require(Items.CHEST, 1)
                    .require(ModItems.MEDIUM_BATTERY_PACK.get())
                    .require(ModItems.WHEEL.get(), 4)
            ...
            VehicleAssemblingRecipeBuilder.entity(ModEntities.SODAYO_PICK_UP_TOW.get(), VehicleAssemblingRecipe.Category.CIVILIAN)
                    .require(ModTags.Items.STORAGE_BLOCK_STEEL, 3)
                    .require(Items.CHEST, 1)
                    .require(ModItems.MEDIUM_BATTERY_PACK.get())
                    .require(ModItems.WHEEL.get(), 4)
