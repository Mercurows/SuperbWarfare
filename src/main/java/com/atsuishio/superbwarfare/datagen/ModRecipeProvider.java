...
public class ModRecipeProvider extends RecipeProvider implements IConditionBuilder {
    ...
    private static void buildAmmoRecipes(Consumer<FinishedRecipe> writer) {
        ...
        ShapedRecipeBuilder.shaped(RecipeCategory.COMBAT, ModItems.SMALL_SHELL_AP.get(), 8)
                ...
                .save(writer, Mod.loc(getItemName(ModItems.SMALL_SHELL_AP.get())));
        ShapedRecipeBuilder.shaped(RecipeCategory.COMBAT, ModItems.SMALL_SHELL_HE.get(), 8)
                ...
                .unlockedBy(getHasName(ModItems.PRIMER.get()), has(ModItems.PRIMER.get()))
                .unlockedBy(getHasName(ModItems.HIGH_ENERGY_EXPLOSIVES.get()), has(ModItems.HIGH_ENERGY_EXPLOSIVES.get()))
                .save(writer, Mod.loc(getItemName(ModItems.SMALL_SHELL_HE.get())));
        ShapedRecipeBuilder.shaped(RecipeCategory.COMBAT, ModItems.SMALL_SHELL_GS.get(), 12)
                ...
                .save(writer, Mod.loc(getItemName(ModItems.SMALL_SHELL_GS.get())));
        ShapedRecipeBuilder.shaped(RecipeCategory.COMBAT, ModItems.SMALL_SHELL_AA.get(), 16)
                ...
                .unlockedBy(getHasName(ModItems.PRIMER.get()), has(ModItems.PRIMER.get()))
                .unlockedBy(getHasName(Items.IRON_INGOT), has(Items.IRON_INGOT))
                .save(writer, Mod.loc(getItemName(ModItems.SMALL_SHELL_AA.get())));
