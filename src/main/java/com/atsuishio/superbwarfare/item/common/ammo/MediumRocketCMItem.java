...
public class MediumRocketCMItem extends Item implements DispenserLaunchable {
    ...
    public AbstractProjectileDispenseBehavior getLaunchBehavior() {
        return new AbstractProjectileDispenseBehavior() {
            ...
            protected @NotNull Projectile getProjectile(Level pLevel, Position pPosition, ItemStack pStack) {
                return new MediumRocketEntity(ModEntities.MEDIUM_ROCKET.get(), pPosition.x(), pPosition.y(), pPosition.z(), pLevel, 300, 12, 300, 0, 0, false, false, true, 50);
            }
