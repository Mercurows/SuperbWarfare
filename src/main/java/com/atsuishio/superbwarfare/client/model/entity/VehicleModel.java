...
public class VehicleModel<T extends VehicleEntity & GeoAnimatable> extends GeoModel<T> {
    ...
    public void setCustomAnimations(T vehicle, long instanceId, AnimationState<T> animationState) {
        ...
        // turret上的成员武器站Yaw
        CoreGeoBone passengerWeaponStationYaw = getAnimationProcessor().getBone("passengerWeaponStationYaw");
        ...
        // turret上的成员武器站Pitch
        CoreGeoBone passengerWeaponStationPitch = getAnimationProcessor().getBone("passengerWeaponStationPitch");
