...
class Bmp2Model : VehicleModel<Bmp2Entity>() {
    override fun collectTransform(boneName: String): TransformContext<Bmp2Entity>? {
        if (boneName == "base" || boneName == "TrackL" || boneName == "TrackR") {
