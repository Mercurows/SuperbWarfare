...
//        this.addRenderLayer(new TruckLayer(this));
    ...
    @Override
    public void renderRecursively(PoseStack poseStack, TruckEntity animatable, GeoBone bone, RenderType renderType, MultiBufferSource bufferSource, VertexConsumer buffer, boolean isReRender, float partialTick, int packedLight, int packedOverlay, float red, float green, float blue, float alpha) {
