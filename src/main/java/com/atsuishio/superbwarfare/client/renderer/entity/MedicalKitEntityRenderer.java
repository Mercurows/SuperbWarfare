...
public class MedicalKitEntityRenderer extends GeoEntityRenderer<MedicalKitEntity> {
    ...
    @Override
    public void preRender(PoseStack poseStack, MedicalKitEntity entity, BakedGeoModel model, MultiBufferSource bufferSource, VertexConsumer buffer, boolean isReRender, float partialTick, int packedLight, int packedOverlay, int color) {
        float scale = 1f;
