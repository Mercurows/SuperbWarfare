...
public class GeHelmetM35ArmorRenderer extends GeoArmorRenderer<GeHelmetM35> implements ICurioRenderer {
    ...
    public <T extends LivingEntity, M extends EntityModel<T>> void render(ItemStack stack, SlotContext slotContext, PoseStack matrixStack, RenderLayerParent<T, M> renderLayerParent, MultiBufferSource renderTypeBuffer, int light, float limbSwing, float limbSwingAmount, float partialTicks, float ageInTicks, float netHeadYaw, float headPitch) {
        ...
        this.prepForRender(slotContext.entity(), stack, EquipmentSlot.HEAD, helmetModel, renderTypeBuffer, partialTicks, limbSwing, limbSwingAmount, netHeadYaw, headPitch);
        ...
        this.renderToBuffer(matrixStack, renderTypeBuffer.getBuffer(RenderType.entityTranslucent(getTextureLocation((GeHelmetM35) stack.getItem()))), light, OverlayTexture.NO_OVERLAY, 0xFFFFFFFF);
