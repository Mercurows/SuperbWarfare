...
public class TowRenderer extends VehicleRenderer<TowEntity> {
    ...
    @Override
    public void renderRecursively(PoseStack poseStack, TowEntity animatable, GeoBone bone, RenderType renderType, MultiBufferSource bufferSource, VertexConsumer buffer, boolean isReRender, float partialTick, int packedLight, int packedOverlay, int color) {
