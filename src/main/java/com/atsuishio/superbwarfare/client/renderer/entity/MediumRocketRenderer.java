...
public class MediumRocketRenderer extends GeoEntityRenderer<MediumRocketEntity> {
    ...
    @Override
    public void preRender(PoseStack poseStack, MediumRocketEntity entity, BakedGeoModel model, MultiBufferSource bufferSource, VertexConsumer buffer, boolean isReRender, float partialTick, int packedLight, int packedOverlay, float red, float green,
