...
public class MediumRocketRenderer extends GeoEntityRenderer<MediumRocketEntity> {
    ...
    @Override
    public void defaultRender(PoseStack poseStack, MediumRocketEntity animatable, MultiBufferSource bufferSource, @Nullable RenderType renderType, @Nullable VertexConsumer buffer, float yaw, float partialTick, int packedLight) {
        poseStack.pushPose();
