...
public class Ptkm1rRenderer extends GeoEntityRenderer<Ptkm1rEntity> {
    ...
    @Override
    public void preRender(PoseStack poseStack, Ptkm1rEntity entity, BakedGeoModel model, MultiBufferSource bufferSource, VertexConsumer buffer, boolean isReRender, float partialTick, int packedLight, int packedOverlay, float red, float green,
    ...
    @Override
    public void render(Ptkm1rEntity entityIn, float entityYaw, float partialTicks, PoseStack poseStack, MultiBufferSource bufferIn, int packedLightIn) {
