...
public class MortarShellRenderer extends GeoEntityRenderer<MortarShellEntity> {
    ...
    @Override
    public void render(MortarShellEntity entityIn, float entityYaw, float partialTicks, PoseStack poseStack, @NotNull MultiBufferSource bufferIn, int packedLightIn) {
        poseStack.pushPose();
