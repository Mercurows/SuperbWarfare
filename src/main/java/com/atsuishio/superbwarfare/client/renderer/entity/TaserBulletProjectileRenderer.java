...
public class TaserBulletProjectileRenderer extends GeoEntityRenderer<TaserBulletEntity> {
    ...
    @Override
    public void render(TaserBulletEntity entityIn, float entityYaw, float partialTicks, PoseStack poseStack, @NotNull MultiBufferSource bufferIn, int packedLightIn) {
        poseStack.pushPose();
