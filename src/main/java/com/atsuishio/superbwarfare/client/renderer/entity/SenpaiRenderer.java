...
public class SenpaiRenderer extends EntityRenderer<SenpaiEntity> {
    public static ResourceLocation TEXTURE = Mod.loc("textures/entity/senpai.png");
    ...
    @Override
    public @NotNull ResourceLocation getTextureLocation(@NotNull SenpaiEntity pEntity) {
        return TEXTURE;
    }
