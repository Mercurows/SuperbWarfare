...
class T90aRenderer(renderManager: EntityRendererProvider.Context) :
    ...
    override fun preRender(poseStack: PoseStack?, entity: T90aEntity?, model: BakedGeoModel?, bufferSource: MultiBufferSource?, buffer: VertexConsumer?, isReRender: Boolean, partialTick: Float, packedLight: Int, packedOverlay: Int, red: Float, green: Float,
