...
public class SwarmDroneRenderer extends GeoEntityRenderer<SwarmDroneEntity> {
    ...
    @Override
    public void render(SwarmDroneEntity entityIn, float entityYaw, float partialTicks, PoseStack poseStack, @NotNull MultiBufferSource bufferIn, int packedLightIn) {
        poseStack.pushPose();
