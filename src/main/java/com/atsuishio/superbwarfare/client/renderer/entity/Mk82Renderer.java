...
public class Mk82Renderer extends GeoEntityRenderer<Mk82Entity> {
    ...
    @Override
    public void defaultRender(PoseStack poseStack, Mk82Entity animatable, MultiBufferSource bufferSource, @Nullable RenderType renderType, @Nullable VertexConsumer buffer, float yaw, float partialTick, int packedLight) {
        poseStack.pushPose();
