...
public class PtkmProjectileRenderer extends GeoEntityRenderer<PtkmProjectileEntity> {
    ...
    @Override
    public void preRender(PoseStack poseStack, PtkmProjectileEntity entity, BakedGeoModel model, MultiBufferSource bufferSource, VertexConsumer buffer, boolean isReRender, float partialTick, int packedLight, int packedOverlay, int color) {
        float scale = 1f;
