...
public class PtkmProjectileRenderer extends GeoEntityRenderer<PtkmProjectileEntity> {
    ...
    @Override
    public void defaultRender(PoseStack poseStack, PtkmProjectileEntity animatable, MultiBufferSource bufferSource, @Nullable RenderType renderType, @Nullable VertexConsumer buffer, float yaw, float partialTick, int packedLight) {
        poseStack.pushPose();
