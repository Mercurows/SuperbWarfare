...
public class Bl132Renderer extends GeoEntityRenderer<Bl132Entity> {
    ...
    @Override
    public void preRender(PoseStack poseStack, Bl132Entity entity, BakedGeoModel model, MultiBufferSource bufferSource, VertexConsumer buffer, boolean isReRender, float partialTick, int packedLight, int packedOverlay, int color) {
        float scale = 1f;
