...
public class Kh39Layer extends GeoRenderLayer<Kh39Entity> {
	private static final ResourceLocation LAYER = Mod.loc("textures/entity/rpg_rocket_e.png");

	public Kh39Layer(GeoRenderer<Kh39Entity> entityRenderer) {
		super(entityRenderer);
	}

	@Override
	public void render(PoseStack poseStack, Kh39Entity animatable, BakedGeoModel bakedModel, RenderType renderType, MultiBufferSource bufferSource, VertexConsumer buffer, float partialTick, int packedLight, int packedOverlay) {
