...
public class WireGuideMissileLayer extends GeoRenderLayer<WireGuideMissileEntity> {
	private static final ResourceLocation LAYER = Mod.loc("textures/entity/rpg_rocket_e.png");

    public WireGuideMissileLayer(GeoRenderer<WireGuideMissileEntity> entityRenderer) {
        super(entityRenderer);
    }

    @Override
    public void render(PoseStack poseStack, WireGuideMissileEntity animatable, BakedGeoModel bakedModel, RenderType renderType, MultiBufferSource bufferSource, VertexConsumer buffer, float partialTick, int packedLight, int packedOverlay) {
