...
public class RpgRocketTBGLayer extends GeoRenderLayer<RpgRocketTBGEntity> {
	private static final ResourceLocation LAYER = Mod.loc("textures/entity/rpg_rocket_e.png");

    public RpgRocketTBGLayer(GeoRenderer<RpgRocketTBGEntity> entityRenderer) {
        super(entityRenderer);
    }

    @Override
    public void render(PoseStack poseStack, RpgRocketTBGEntity animatable, BakedGeoModel bakedModel, RenderType renderType, MultiBufferSource bufferSource, VertexConsumer buffer, float partialTick, int packedLight, int packedOverlay) {
