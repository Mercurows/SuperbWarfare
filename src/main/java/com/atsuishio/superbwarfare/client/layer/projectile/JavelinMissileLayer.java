...
public class JavelinMissileLayer extends GeoRenderLayer<JavelinMissileEntity> {
	private static final ResourceLocation LAYER = Mod.loc("textures/entity/rpg_rocket_e.png");

    public JavelinMissileLayer(GeoRenderer<JavelinMissileEntity> entityRenderer) {
