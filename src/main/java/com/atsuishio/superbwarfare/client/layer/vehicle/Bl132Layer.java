...
public class Bl132Layer extends GeoRenderLayer<Bl132Entity> {
    private static final ResourceLocation LAYER = Mod.loc("textures/entity/sherman_e.png");

    public Bl132Layer(GeoRenderer<Bl132Entity> entityRenderer) {
        super(entityRenderer);
    }

    @Override
    public void render(PoseStack poseStack, Bl132Entity animatable, BakedGeoModel bakedModel, RenderType renderType, MultiBufferSource bufferSource, VertexConsumer buffer, float partialTick, int packedLight, int packedOverlay) {
