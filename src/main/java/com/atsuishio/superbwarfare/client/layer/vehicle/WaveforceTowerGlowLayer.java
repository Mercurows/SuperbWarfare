...
public class WaveforceTowerGlowLayer extends GeoRenderLayer<WaveforceTowerEntity> {

    private static final ResourceLocation LAYER = Mod.loc("textures/entity/waveforce_tower_glow_e.png");

    public WaveforceTowerGlowLayer(GeoRenderer<WaveforceTowerEntity> entityRenderer) {
