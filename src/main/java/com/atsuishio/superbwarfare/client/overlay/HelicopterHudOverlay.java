    ...
    public void render(ForgeGui gui, GuiGraphics guiGraphics, float partialTick, int screenWidth, int screenHeight) {
        ...
        if (player.getVehicle() instanceof ArmedVehicleEntity armedVehicle
            ...
            if (Minecraft.getInstance().options.getCameraType() == CameraType.FIRST_PERSON) {
                ...
                RenderHelper.blit(poseStack, Mod.loc("textures/screens/compass.png"), (float) screenWidth / 2 - 128, (float) 6, 128 + ((float) 64 / 45 * vehicle.getYRot()), 0, 256, 16, 512, 16, color);
