...
public class AircraftHud {
    ...
    public static void render(VehicleEntity vehicle, Player player, GuiGraphics guiGraphics, float partialTick, int screenWidth, int screenHeight) {
        ...
        Vec3 posCross = vehicle.getShootPosForHud(player, partialTick).add(vehicle.getShootDirectionForHud(player, partialTick).scale(192));
...
//
//            // 热诱弹
//            guiGraphics.drawString(Minecraft.getInstance().font, Component.literal("IR FLARES " + vehicle.getDecoyState()), (int) x + 72, (int) y, vehicle.getDecoyState().equals("READY") ? color : 0xFF0000, false);
...
//                }
//
//                guiGraphics.drawString(Minecraft.getInstance().font, Component.literal("IR FLARES " + vehicle.getDecoyState()), 25, 1, vehicle.getDecoyState().equals("READY") ? -1 : 0xFF0000, false);
//                poseStack.popPose();
