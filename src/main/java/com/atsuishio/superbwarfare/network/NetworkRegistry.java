...
public class NetworkRegistry {
    public static void register() {
        ...
        playToClient(ResetCameraTypeMessage.class, ResetCameraTypeMessage::encode, ResetCameraTypeMessage::decode, ResetCameraTypeMessage::handler);
        ...
        playToClient(RadarMenuCloseMessage.class, RadarMenuCloseMessage::encode, RadarMenuCloseMessage::decode, RadarMenuCloseMessage::handler);
        ...
        playToClient(DogTagEditorMessage.class, DogTagEditorMessage::encode, DogTagEditorMessage::decode, DogTagEditorMessage::handler);
        ...
        playToServer(GunReforgeMessage.class, GunReforgeMessage::encode, GunReforgeMessage::decode, GunReforgeMessage::handler);
        ...
        playToServer(ReloadMessage.class, ReloadMessage::encode, ReloadMessage::decode, ReloadMessage::handler);
        ...
        playToServer(InteractMessage.class, InteractMessage::encode, InteractMessage::decode, InteractMessage::handler);
