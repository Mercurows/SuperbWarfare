...
class Perks(gun: GunData) {
    ...
    fun getTag(registry: DeferredHolder<Perk, Perk>): CompoundTag {
    ...
    fun getLevel(perk: DeferredHolder<Perk, out Perk>): Short {
    ...
    fun get(type: Perk.Type): Perk? {
        val perksRegistry = mutableListOf<DeferredHolder<Perk, out Perk>>()
    ...
    fun reduceCooldown(registry: DeferredHolder<Perk, Perk>, name: String) {
