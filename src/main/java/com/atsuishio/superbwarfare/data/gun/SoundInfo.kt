...
class SoundInfo {
    ...
    @SerializedName("FireSoundInstances1P")
    @SerialName("FireSoundInstances1P")
    var fireSoundInstances1P: SerializedSoundEvent? = null

    @SerializedName("FireSoundInstances3P")
