...
public class ModEntityRenderers {
    ...
    public static void registerEntityRenderers(EntityRenderersEvent.RegisterRenderers event) {
        ...
        event.registerEntityRenderer(ModEntities.SC_50.get(), Sc50Renderer::new);
        event.registerEntityRenderer(ModEntities.SC_250.get(), Sc250Renderer::new);
        ...
        event.registerEntityRenderer(ModEntities.SUPER_STAR_PROJECTILE.get(), SuperStarProjectileRenderer::new);
        ...
        event.registerEntityRenderer(ModEntities.SODAYO_PICK_UP_TOW.get(), SodayoPickUpTowRenderer::new);
...
//        event.registerEntityRenderer(ModEntities.STEEL_COIL.get(), SteelCoilRenderer::new);
        ...
        event.registerEntityRenderer(ModEntities.KV_16.get(), Kv16Renderer::new);
        event.registerEntityRenderer(ModEntities.JU_87.get(), Ju87Renderer::new);
    }
}
