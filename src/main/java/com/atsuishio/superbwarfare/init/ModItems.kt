...
object ModItems {
    ...
    @JvmField val HAMMER = registerItem("hammer") { Hammer(Tiers.IRON, 11, -3.2f, 400) }
    @JvmField val GOLDEN_HAMMER = registerItem("golden_hammer") { Hammer(Tiers.GOLD, 11, -3.2f, 150) }
    @JvmField val STEEL_HAMMER = registerItem("steel_hammer") { Hammer(ModItemTier.STEEL, 9, -3.2f, 600) }
    @JvmField val DIAMOND_HAMMER = registerItem("diamond_hammer") { Hammer(Tiers.DIAMOND, 12, -3.2f, 1500) }
    @JvmField val CEMENTED_CARBIDE_HAMMER = registerItem("cemented_carbide_hammer") { Hammer(ModItemTier.CEMENTED_CARBIDE, 8, -3.2f, 2000) }
    ...
    @JvmField val TRACHELIUM_BLUEPRINT = registerBlueprint("trachelium_blueprint", Rarity.EPIC)
    ...
    @JvmField val SECONDARY_CATACLYSM_BLUEPRINT = registerBlueprint("secondary_cataclysm_blueprint", legendary)
    @JvmField val INSIDIOUS_BLUEPRINT = registerBlueprint("insidious_blueprint", Rarity.EPIC)
    @JvmField val AURELIA_SCEPTRE_BLUEPRINT = registerBlueprint("aurelia_sceptre_blueprint", legendary)
    @JvmField val QL_1031_BLUEPRINT = registerBlueprint("ql_1031_blueprint", legendary)
    ...
    fun registerDispenserBehavior() {
        ...
        DispenserBlock.registerBehavior(BLU_43_MINE.get(), Blu43MineDispenseBehavior())
