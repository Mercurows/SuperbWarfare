...
public class ModSounds {
    ...
    public static final RegistryObject<SoundEvent> NIGHT_VISION_ACTIVATE = REGISTRY.register("night_vision_activate", () -> SoundEvent.createVariableRangeEvent(Mod.loc("night_vision_activate")));
}
