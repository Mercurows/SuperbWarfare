...
public class ModSounds {
    ...
    public static final RegistryObject<SoundEvent> REPAIR_TOOL_FIRE_1P = REGISTRY.register("repair_tool_fire_1p", () -> SoundEvent.createVariableRangeEvent(Mod.loc("repair_tool_fire_1p")));
    public static final RegistryObject<SoundEvent> REPAIR_TOOL_FIRE_3P = REGISTRY.register("repair_tool_fire_3p", () -> SoundEvent.createVariableRangeEvent(Mod.loc("repair_tool_fire_3p")));
    ...
    public static final RegistryObject<SoundEvent> AWM_FIRE_1P = REGISTRY.register("awm_fire_1p", () -> SoundEvent.createVariableRangeEvent(Mod.loc("awm_fire_1p")));
    public static final RegistryObject<SoundEvent> AWM_FIRE_3P = REGISTRY.register("awm_fire_3p", () -> SoundEvent.createVariableRangeEvent(Mod.loc("awm_fire_3p")));
    public static final RegistryObject<SoundEvent> AWM_FIRE_1P_S = REGISTRY.register("awm_fire_1p_s", () -> SoundEvent.createVariableRangeEvent(Mod.loc("awm_fire_1p_s")));
    public static final RegistryObject<SoundEvent> AWM_FIRE_3P_S = REGISTRY.register("awm_fire_3p_s", () -> SoundEvent.createVariableRangeEvent(Mod.loc("awm_fire_3p_s")));
    public static final RegistryObject<SoundEvent> AWM_FAR = REGISTRY.register("awm_far", () -> SoundEvent.createVariableRangeEvent(Mod.loc("awm_far")));
    public static final RegistryObject<SoundEvent> AWM_VERYFAR = REGISTRY.register("awm_veryfar", () -> SoundEvent.createVariableRangeEvent(Mod.loc("awm_veryfar")));
    public static final RegistryObject<SoundEvent> AWM_RELOAD_NORMAL = REGISTRY.register("awm_reload_normal", () -> SoundEvent.createVariableRangeEvent(Mod.loc("awm_reload_normal")));
    public static final RegistryObject<SoundEvent> AWM_RELOAD_EMPTY = REGISTRY.register("awm_reload_empty", () -> SoundEvent.createVariableRangeEvent(Mod.loc("awm_reload_empty")));
    public static final RegistryObject<SoundEvent> AWM_BOLT = REGISTRY.register("awm_bolt", () -> SoundEvent.createVariableRangeEvent(Mod.loc("awm_bolt")));
    ...
    public static final RegistryObject<SoundEvent> M_2_HB_FIRE_1P = REGISTRY.register("m_2_hb_fire_1p", () -> SoundEvent.createVariableRangeEvent(Mod.loc("m_2_hb_fire_1p")));
    public static final RegistryObject<SoundEvent> M_2_HB_FIRE_3P = REGISTRY.register("m_2_hb_fire_3p", () -> SoundEvent.createVariableRangeEvent(Mod.loc("m_2_hb_fire_3p")));
    public static final RegistryObject<SoundEvent> M_2_HB_FAR = REGISTRY.register("m_2_hb_far", () -> SoundEvent.createVariableRangeEvent(Mod.loc("m_2_hb_far")));
    public static final RegistryObject<SoundEvent> M_2_HB_VERYFAR = REGISTRY.register("m_2_hb_veryfar", () -> SoundEvent.createVariableRangeEvent(Mod.loc("m_2_hb_veryfar")));
    public static final RegistryObject<SoundEvent> M_2_HB_RELOAD_NORMAL = REGISTRY.register("m_2_hb_reload_normal", () -> SoundEvent.createVariableRangeEvent(Mod.loc("m_2_hb_reload_normal")));
    public static final RegistryObject<SoundEvent> M_2_HB_RELOAD_EMPTY = REGISTRY.register("m_2_hb_reload_empty", () -> SoundEvent.createVariableRangeEvent(Mod.loc("m_2_hb_reload_empty")));

    public static final RegistryObject<SoundEvent> QBZ_191_FIRE_1P = REGISTRY.register("qbz_191_fire_1p", () -> SoundEvent.createVariableRangeEvent(Mod.loc("qbz_191_fire_1p")));
    public static final RegistryObject<SoundEvent> QBZ_191_FIRE_3P = REGISTRY.register("qbz_191_fire_3p", () -> SoundEvent.createVariableRangeEvent(Mod.loc("qbz_191_fire_3p")));
    public static final RegistryObject<SoundEvent> QBZ_191_FIRE_1P_S = REGISTRY.register("qbz_191_fire_1p_s", () -> SoundEvent.createVariableRangeEvent(Mod.loc("qbz_191_fire_1p_s")));
    public static final RegistryObject<SoundEvent> QBZ_191_FIRE_3P_S = REGISTRY.register("qbz_191_fire_3p_s", () -> SoundEvent.createVariableRangeEvent(Mod.loc("qbz_191_fire_3p_s")));
    public static final RegistryObject<SoundEvent> QBZ_191_FAR = REGISTRY.register("qbz_191_far", () -> SoundEvent.createVariableRangeEvent(Mod.loc("qbz_191_far")));
    public static final RegistryObject<SoundEvent> QBZ_191_VERYFAR = REGISTRY.register("qbz_191_veryfar", () -> SoundEvent.createVariableRangeEvent(Mod.loc("qbz_191_veryfar")));
    public static final RegistryObject<SoundEvent> QBZ_191_RELOAD_NORMAL = REGISTRY.register("qbz_191_reload_normal", () -> SoundEvent.createVariableRangeEvent(Mod.loc("qbz_191_reload_normal")));
    public static final RegistryObject<SoundEvent> QBZ_191_RELOAD_EMPTY = REGISTRY.register("qbz_191_reload_empty", () -> SoundEvent.createVariableRangeEvent(Mod.loc("qbz_191_reload_empty")));
    ...
    public static final RegistryObject<SoundEvent> MEDIUM_MISSILE_RELOAD = REGISTRY.register("medium_missile_reload", () -> SoundEvent.createVariableRangeEvent(Mod.loc("medium_missile_reload")));

    public static final RegistryObject<SoundEvent> SMALL_ROCKET_FIRE_1P = REGISTRY.register("small_rocket_fire_1p", () -> SoundEvent.createVariableRangeEvent(Mod.loc("small_rocket_fire_1p")));
    ...
    // a_10a
    public static final RegistryObject<SoundEvent> A_10A_ENGINE = REGISTRY.register("a_10a_engine", () -> SoundEvent.createVariableRangeEvent(Mod.loc("a_10a_engine")));
    public static final RegistryObject<SoundEvent> A_10A_FIRE = REGISTRY.register("a_10a_fire", () -> SoundEvent.createVariableRangeEvent(Mod.loc("a_10a_fire")));

    // ah_6
    public static final RegistryObject<SoundEvent> AH_6_ENGINE_START = REGISTRY.register("ah_6_engine_start", () -> SoundEvent.createVariableRangeEvent(Mod.loc("ah_6_engine_start")));
    public static final RegistryObject<SoundEvent> AH_6_ENGINE = REGISTRY.register("ah_6_engine", () -> SoundEvent.createVariableRangeEvent(Mod.loc("ah_6_engine")));
    public static final RegistryObject<SoundEvent> AH_6_CANNON_FIRE_1P = REGISTRY.register("ah_6_cannon_fire_1p", () -> SoundEvent.createVariableRangeEvent(Mod.loc("ah_6_cannon_fire_1p")));
    public static final RegistryObject<SoundEvent> AH_6_CANNON_FIRE_3P = REGISTRY.register("ah_6_cannon_fire_3p", () -> SoundEvent.createVariableRangeEvent(Mod.loc("ah_6_cannon_fire_3p")));
    public static final RegistryObject<SoundEvent> AH_6_CANNON_FAR = REGISTRY.register("ah_6_cannon_far", () -> SoundEvent.createVariableRangeEvent(Mod.loc("ah_6_cannon_far")));
    public static final RegistryObject<SoundEvent> AH_6_CANNON_VERYFAR = REGISTRY.register("ah_6_cannon_veryfar", () -> SoundEvent.createVariableRangeEvent(Mod.loc("ah_6_cannon_veryfar")));

    // bmp_2
    public static final RegistryObject<SoundEvent> BMP_2_CANNON_FIRE_1P = REGISTRY.register("bmp_2_cannon_fire_1p", () -> SoundEvent.createVariableRangeEvent(Mod.loc("bmp_2_cannon_fire_1p")));
    public static final RegistryObject<SoundEvent> BMP_2_CANNON_FIRE_3P = REGISTRY.register("bmp_2_cannon_fire_3p", () -> SoundEvent.createVariableRangeEvent(Mod.loc("bmp_2_cannon_fire_3p")));
    public static final RegistryObject<SoundEvent> BMP_2_ENGINE = REGISTRY.register("bmp_2_engine", () -> SoundEvent.createVariableRangeEvent(Mod.loc("bmp_2_engine")));
    public static final RegistryObject<SoundEvent> BMP_2_MISSILE_FIRE_1P = REGISTRY.register("bmp_2_missile_fire_1p", () -> SoundEvent.createVariableRangeEvent(Mod.loc("bmp_2_missile_fire_1p")));
    public static final RegistryObject<SoundEvent> BMP_2_MISSILE_FIRE_3P = REGISTRY.register("bmp_2_missile_fire_3p", () -> SoundEvent.createVariableRangeEvent(Mod.loc("bmp_2_missile_fire_3p")));
    ...
    // lav_150
    public static final RegistryObject<SoundEvent> LAV_150_CANNON_FIRE_1P = REGISTRY.register("lav_150_cannon_fire_1p", () -> SoundEvent.createVariableRangeEvent(Mod.loc("lav_150_cannon_fire_1p")));
    public static final RegistryObject<SoundEvent> LAV_150_CANNON_FIRE_3P = REGISTRY.register("lav_150_cannon_fire_3p", () -> SoundEvent.createVariableRangeEvent(Mod.loc("lav_150_cannon_fire_3p")));
    ...
    // speedboat
    public static final RegistryObject<SoundEvent> SPEEDBOAT_ENGINE = REGISTRY.register("speedboat_engine", () -> SoundEvent.createVariableRangeEvent(Mod.loc("speedboat_engine")));

    // tom_6
    public static final RegistryObject<SoundEvent> TOM_6_ENGINE = REGISTRY.register("tom_6_engine", () -> SoundEvent.createVariableRangeEvent(Mod.loc("tom_6_engine")));
    ...
    public static final RegistryObject<SoundEvent> QL_1031_DISCHARGE = REGISTRY.register("ql_1031_discharge", () -> SoundEvent.createVariableRangeEvent(Mod.loc("ql_1031_discharge")));
    public static final RegistryObject<SoundEvent> QL_1031_FIRE_1P_SEMI = REGISTRY.register("ql_1031_fire_1p_semi", () -> SoundEvent.createVariableRangeEvent(Mod.loc("ql_1031_fire_1p_semi")));
    public static final RegistryObject<SoundEvent> QL_1031_FIRE_3P_SEMI = REGISTRY.register("ql_1031_fire_3p_semi", () -> SoundEvent.createVariableRangeEvent(Mod.loc("ql_1031_fire_3p_semi")));
    public static final RegistryObject<SoundEvent> QL_1031_FIRE_1P_S_SEMI = REGISTRY.register("ql_1031_fire_1p_s_semi", () -> SoundEvent.createVariableRangeEvent(Mod.loc("ql_1031_fire_1p_s_semi")));
    public static final RegistryObject<SoundEvent> QL_1031_FIRE_3P_S_SEMI = REGISTRY.register("ql_1031_fire_3p_s_semi", () -> SoundEvent.createVariableRangeEvent(Mod.loc("ql_1031_fire_3p_s_semi")));
    public static final RegistryObject<SoundEvent> QL_1031_FAR_SEMI = REGISTRY.register("ql_1031_far_semi", () -> SoundEvent.createVariableRangeEvent(Mod.loc("ql_1031_far_semi")));
    public static final RegistryObject<SoundEvent> QL_1031_VERYFAR_SEMI = REGISTRY.register("ql_1031_veryfar_semi", () -> SoundEvent.createVariableRangeEvent(Mod.loc("ql_1031_veryfar_semi")));
    public static final RegistryObject<SoundEvent> QL_1031_FAR_S_SEMI = REGISTRY.register("ql_1031_far_s_semi", () -> SoundEvent.createVariableRangeEvent(Mod.loc("ql_1031_far_s_semi")));
    public static final RegistryObject<SoundEvent> QL_1031_VERYFAR_S_SEMI = REGISTRY.register("ql_1031_veryfar_s_semi", () -> SoundEvent.createVariableRangeEvent(Mod.loc("ql_1031_veryfar_s_semi")));
    public static final RegistryObject<SoundEvent> QL_1031_FIRE_1P_AUTO = REGISTRY.register("ql_1031_fire_1p_auto", () -> SoundEvent.createVariableRangeEvent(Mod.loc("ql_1031_fire_1p_auto")));
    public static final RegistryObject<SoundEvent> QL_1031_FIRE_3P_AUTO = REGISTRY.register("ql_1031_fire_3p_auto", () -> SoundEvent.createVariableRangeEvent(Mod.loc("ql_1031_fire_3p_auto")));
    public static final RegistryObject<SoundEvent> QL_1031_FIRE_1P_S_AUTO = REGISTRY.register("ql_1031_fire_1p_s_auto", () -> SoundEvent.createVariableRangeEvent(Mod.loc("ql_1031_fire_1p_s_auto")));
    public static final RegistryObject<SoundEvent> QL_1031_FIRE_3P_S_AUTO = REGISTRY.register("ql_1031_fire_3p_s_auto", () -> SoundEvent.createVariableRangeEvent(Mod.loc("ql_1031_fire_3p_s_auto")));
    public static final RegistryObject<SoundEvent> QL_1031_FAR_AUTO = REGISTRY.register("ql_1031_far_auto", () -> SoundEvent.createVariableRangeEvent(Mod.loc("ql_1031_far_auto")));
    public static final RegistryObject<SoundEvent> QL_1031_VERYFAR_AUTO = REGISTRY.register("ql_1031_veryfar_auto", () -> SoundEvent.createVariableRangeEvent(Mod.loc("ql_1031_veryfar_auto")));
    public static final RegistryObject<SoundEvent> QL_1031_FAR_S_AUTO = REGISTRY.register("ql_1031_far_s_auto", () -> SoundEvent.createVariableRangeEvent(Mod.loc("ql_1031_far_s_auto")));
    public static final RegistryObject<SoundEvent> QL_1031_VERYFAR_S_AUTO = REGISTRY.register("ql_1031_veryfar_s_auto", () -> SoundEvent.createVariableRangeEvent(Mod.loc("ql_1031_veryfar_s_auto")));
