...
public class ModItems {
    ...
    public static final RegistryObject<Item> REPAIR_TOOL = GUNS.register("repair_tool", RepairToolItem::new);
    ...
    public static final RegistryObject<Item> TRACHELIUM = GUNS.register("trachelium", TracheliumItem::new);
    ...
    public static final RegistryObject<Item> AWM = GUNS.register("awm", AwmItem::new);
    ...
    public static final RegistryObject<Item> SUPER_STAR_SHOOTER = GUNS.register("super_star_shooter", SuperStarShooterItem::new);
    ...
    public static final RegistryObject<Item> ARTILLERY_INDICATOR = ITEMS.register("artillery_indicator", ArtilleryIndicator::new);
    ...
    public static final RegistryObject<Item> HAMMER = ITEMS.register("hammer", () -> new Hammer(Tiers.IRON, 11, -3.2f, new Item.Properties().durability(400)));
    public static final RegistryObject<Item> GOLDEN_HAMMER = ITEMS.register("golden_hammer", () -> new Hammer(Tiers.GOLD, 11, -3.2f, new Item.Properties().durability(150)));
    public static final RegistryObject<Item> STEEL_HAMMER = ITEMS.register("steel_hammer", () -> new Hammer(ModItemTier.STEEL, 9, -3.2f, new Item.Properties().durability(600)));
    public static final RegistryObject<Item> DIAMOND_HAMMER = ITEMS.register("diamond_hammer", () -> new Hammer(Tiers.DIAMOND, 12, -3.2f, new Item.Properties().durability(1500)));
    public static final RegistryObject<Item> CEMENTED_CARBIDE_HAMMER = ITEMS.register("cemented_carbide_hammer", () -> new Hammer(ModItemTier.CEMENTED_CARBIDE, 8, -3.2f, new Item.Properties().durability(2000)));
    ...
    public static final RegistryObject<Item> US_HELMET_PASGT = ITEMS.register("us_helmet_pasgt", UsHelmetPasgt::new);
    ...
    public static final RegistryObject<Item> THERMAL_IMAGING_GOGGLES = ITEMS.register("thermal_imaging_goggles", ThermalImagingGogglesItem::new);
    ...
    public static final RegistryObject<Item> TOW_DEPLOYER = ITEMS.register("tow_deployer", TowDeployer::new);
    ...
    public static final RegistryObject<Item> DOG_TAG = ITEMS.register("dog_tag", DogTagItem::new);
    public static final RegistryObject<Item> IFF = ITEMS.register("iff", IffItem::new);
    ...
    public static final RegistryObject<Item> LASER_UNIT = ITEMS.register("laser_unit", () -> new Item(new Item.Properties()));
    ...
    public static final RegistryObject<Item> VEHICLE_RESET_KIT = ITEMS.register("vehicle_reset_kit", VehicleResetKit::new);
    ...
    public static final RegistryObject<Item> AWM_BLUEPRINT = ITEMS.register("awm_blueprint", () -> new BlueprintItem(Rarity.EPIC));
    ...
    public static final RegistryObject<Item> VEHICLE_ASSEMBLING_TABLE = BLOCKS.register("vehicle_assembling_table", VehicleAssemblingTableBlockItem::new);
