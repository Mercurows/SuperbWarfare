...
public class ModItems {
    ...
    public static final DeferredHolder<Item, MortarShell> MORTAR_SHELL = AMMO.register("mortar_shell", () -> new MortarShell(MortarShellEntity.Type.NORMAL));
    public static final DeferredHolder<Item, MortarShell> MORTAR_SHELL_WP = AMMO.register("mortar_shell_wp", () -> new MortarShell(MortarShellEntity.Type.WP));
    public static final DeferredHolder<Item, PotionMortarShell> POTION_MORTAR_SHELL = AMMO.register("potion_mortar_shell", () -> new PotionMortarShell(MortarShellEntity.Type.NORMAL));
