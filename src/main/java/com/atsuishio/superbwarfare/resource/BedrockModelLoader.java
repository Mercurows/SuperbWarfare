...
public class BedrockModelLoader {
    public static final ResourceLocation SENPAI_MODEL = new ResourceLocation(com.atsuishio.superbwarfare.Mod.MODID,
            "entity/senpai.geo");

    public static final ResourceLocation SENPAI_ANI = new ResourceLocation(com.atsuishio.superbwarfare.Mod.MODID,
            "senpai.animation");
