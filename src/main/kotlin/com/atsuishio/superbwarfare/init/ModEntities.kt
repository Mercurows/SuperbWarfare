...
object ModEntities {
    ...
    val SENPAI = register(
        ...
        EntityType.Builder.of(::SenpaiEntity, MobCategory.MONSTER)
            .setTrackingRange(64).setUpdateInterval(3).eyeHeight(1.75f).sized(0.6f, 2f)
    )
...
//    val STEEL_COIL = register("steel_coil", vehicle(::SteelCoilEntity).sized(2f, 2f))
    ...
    @JvmField
    val BMP_2 = register("bmp_2", vehicle(::Bmp2Entity).sized(4f, 3f))

    @JvmField
    val T_90A = register("t_90a", vehicle(::T90aEntity).sized(4.2f, 2.5f))
