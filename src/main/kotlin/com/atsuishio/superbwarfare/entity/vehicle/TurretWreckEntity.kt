...
open class TurretWreckEntity(type: EntityType<TurretWreckEntity>, world: Level) : Entity(type, world), GeoEntity {
    ...
    companion object {
        ...
        val BARREL_PITCH: EntityDataAccessor<Float> = SynchedEntityData.defineId(TurretWreckEntity::class.java, EntityDataSerializers.FLOAT)
    ...
    override fun defineSynchedData() {
        ...
        entityData.define(BARREL_PITCH, 0f)
