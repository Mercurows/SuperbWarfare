...
class Kv16Renderer<T>(manager: EntityRendererProvider.Context) :
    ...
    override fun transformCustomModelPart(
        ...
        val shell1 = model.getBone("shell1")
        val shell2 = model.getBone("shell2")
        val shell3 = model.getBone("shell3")

        shell1.visible = !shouldHideBomb(vehicle, 3)
        shell2.visible = !shouldHideBomb(vehicle, 2)
        shell3.visible = !shouldHideBomb(vehicle, 1)
    }
