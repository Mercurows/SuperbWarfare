...
object ClientSyncedEntityHandler {
    ...
    data class ClientSyncedPlayerInfo(val pos: Vec3, val name: String, val timeStamp: Int, val onVehicle: Boolean, val isDriver: Boolean)

    data class ClientSyncedPlayer(val uuid: UUID, val pos: Vec3, val name: String, val onVehicle: Boolean, val isDriver: Boolean)
