...
object OldAircraftHud {
    ...
    fun render(
        ...
        if ((mc.options.cameraType == CameraType.FIRST_PERSON || ClientEventHandler.zoomVehicle) && VectorUtil.canSee(
            ...
            RenderHelper.blit(poseStack, HUD_BASE, x - 36, y - 36, 0f, 0f, 72f, 72f, 72f, 72f, color)
            RenderHelper.blit(poseStack, CROSS_HAIR, x - 160, y - 160, 0f, 0f, 320f, 320f, 320f, 320f, color)
