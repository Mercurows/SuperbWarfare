...
class RuHelmet6b47Item : GeoArmorItem(ModArmorMaterial.CEMENTED_CARBIDE, Type.HELMET, Properties()) {
    override fun initializeClient(consumer: Consumer<IClientItemExtensions?>) {
        consumer.accept(object : IClientItemExtensions {
            ...
            override fun getHumanoidArmorModel(
                ...
                if (this.renderer == null) this.renderer = RuHelmet6b47ArmorRenderer()
