...
class RuChest6b43Item : GeoArmorItem(ModArmorMaterial.CEMENTED_CARBIDE, Type.CHESTPLATE, Properties()) {
    override fun initializeClient(consumer: Consumer<IClientItemExtensions?>) {
        consumer.accept(object : IClientItemExtensions {
            ...
            override fun getHumanoidArmorModel(
                ...
                if (this.renderer == null) this.renderer = RuChest6b43ArmorRenderer()
